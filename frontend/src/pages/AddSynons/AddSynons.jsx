      ...
      <div className="flex flex-col relative justify-center items-center md:shadow-md md:my-8 bg-[lightseagreen] rounded-xl">
        ...
        <div className="flex flex-col gap-5 w-11/12 md:w-4/5">
            ...
            {Object.keys(synonyms)?.length ? (
              Object.keys(synonyms)?.map((synon) => (
                ...
                >
                  <img
                    className="w-5 mr-2"
                    src="https://cdn-icons-png.flaticon.com/512/9282/9282725.png"
                    alt="bulletin"
                  />
          ...
          >
            {loading ? (
              <div
                className="inline-block h-4 w-4 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] mr-4 -ml-6"
                role="status"
              >
